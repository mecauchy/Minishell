...
#    Updated: 2025/05/14 15:58:58 by vluo             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC				=	$(SRC_DIR)split_cmds.c $(SRC_DIR)get_correct_cmd.c	\
					...
					$(SRC_DIR)utils3.c $(SRC_DIR)is_correct_cmds.c		\
					$(SRC_DIR)redirection.c $(SRC_DIR)wait_upex.c		\
					$(SRC_DIR)minishell.c								\
...
$(NAME)			:	$(LIBFT) $(OBJ_DIR) $(OBJ)
					@$(CC) $(CFLAGS) -I $(INC) $(OBJ) $(LIBFT) -o $(NAME) $(READLINEFLAGS)
					@clear
